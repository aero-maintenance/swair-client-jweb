...
public class Connexion extends HttpServlet {
    ...
    public static final String ATT_SESSION_AC_LIST			= "sessionAircraftList";
    public static final String COOKIE_DERNIERE_CONNEXION 	= "derniereConnexion";
    public static final String FORMAT_DATE               	= "dd/MM/yyyy HH:mm:ss";
    public static final String VUE_CONNEXION              	= "/WEB-INF/connexion.jsp";
    public static final String VUE_FLIGHT_REGISTERING		= "/account/creationVol.jsp";
    ...
    public void doPost( HttpServletRequest request, HttpServletResponse response ) throws ServletException, IOException {
        ...
        Utilisateur utilisateur = form.verifier_utilisateur(request); 
        Map<Long, Aircraft> mapAvions = new HashMap<Long, Aircraft>();
        if(utilisateur != null) {
        	
        	System.out.println("Validation de l'utilisateur");
        	List<Aircraft> listeAvions = aircraftDao.filtrer(utilisateur.getUser_id());
            for ( Aircraft aircraft : listeAvions ) {
                mapAvions.put( aircraft.getAc_id(), aircraft );
            }
        	valid_user = true;
        }
        ...
        if ( form.getErreurs().isEmpty() ) {
            ...
            session.setAttribute(ATT_SESSION_AC_LIST, mapAvions);
        } else {
        ...
        if(valid_user) {
        	request.setAttribute(ATT_SESSION_AC_LIST, mapAvions);
